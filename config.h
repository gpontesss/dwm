...
static const char *fonts[]          = { "NotoSansMono:size=10", "Siji:size=10" };
...
static Key keys[] = {
    ...
    { MODKEY,                XK_space,  spawn, SHCMD("switchkb") },

    { 0, XF86XK_AudioMute,         spawn, SHCMD("pamixer --toggle-mute") },
    { 0, XF86XK_AudioRaiseVolume,  spawn, SHCMD("pamixer --allow-boost --increase 5") },
    { 0, XF86XK_AudioLowerVolume,  spawn, SHCMD("pamixer --allow-boost --decrease 5") },
